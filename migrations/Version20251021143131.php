 ...
 */
final class Version20251021143131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat_id INT DEFAULT NULL, ADD organisateur_id INT DEFAULT NULL, ADD site_organisateur_id INT DEFAULT NULL, CHANGE etatsortie lieu_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etatsortie INT DEFAULT NULL, DROP lieu_id, DROP etat_id, DROP organisateur_id, DROP site_organisateur_id');
    }
}
